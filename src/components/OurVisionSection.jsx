...
const OurVisionSection = () => {
  return (
    <section className="relative flex w-full min-h-[55vh]  justify-between bg-light-blue overflow-hidden ">
      ...
      {/* Text Section */}
      <div className="w-[45%] flex flex-col justify-center  p-2 ">
        <h3 className="text-gold text-2xl text-right sm:text-3xl -mt-8 font-bold mb-2">
          Our Vision
        </h3>
        <p className="text-[14px] sm:text-lg  mt-10 font-normal text-white leading-relaxed">
          <span className="text-gold font-bold text-left"><strong>Walkin'oodle </strong></span><br/>
